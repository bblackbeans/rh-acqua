...
echo "🔍 TESTE SEM SUDO - PROBLEMA DE AMBIENTE"
echo "======================================="
...
echo ""
echo "3️⃣ VERIFICANDO CONTAINER (sem sudo)"
echo "==================================="

echo "📋 Status do container:"
docker ps --filter 'name=rh-acqua-web-1' --format "{{.Names}}: {{.Status}}" 2>/dev/null || echo "❌ Não foi possível verificar container (precisa sudo)"
